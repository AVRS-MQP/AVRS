			...
			action_name_(name)
	{
		...
		void executeCB(const motion_msgs::MoveRobotQuatGoalConstPtr &goal)
		{
			...
			if(mode==0){
				...
				move_group.setJointValueTarget("joint_1",0.0);
				move_group.setJointValueTarget("joint_2",0.0);
				move_group.setJointValueTarget("joint_3",0.0);
				move_group.setJointValueTarget("joint_4",0.0);
				move_group.setJointValueTarget("joint_5",0.0);
				move_group.setJointValueTarget("joint_6",0.0);
				move_group.move();
